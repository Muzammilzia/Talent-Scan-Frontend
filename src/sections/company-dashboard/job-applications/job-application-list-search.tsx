...
interface JobApplicationsListSearchProps {
...
export const JobApplicationsListSearch: FC<JobApplicationsListSearchProps> = (props) => {
...
JobApplicationsListSearch.propTypes = {
