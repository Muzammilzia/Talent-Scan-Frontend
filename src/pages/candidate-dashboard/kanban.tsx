...
import { TaskModal } from 'src/sections/candidate-dashboard/kanban/task-modal';
import { ColumnCard } from 'src/sections/candidate-dashboard/kanban/column-card';
import { ColumnAdd } from 'src/sections/candidate-dashboard/kanban/column-add';
