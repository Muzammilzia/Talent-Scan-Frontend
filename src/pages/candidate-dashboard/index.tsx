...
import { OverviewBanner } from 'src/sections/candidate-dashboard/overview/overview-banner';
import { OverviewDoneTasks } from 'src/sections/candidate-dashboard/overview/overview-done-tasks';
import { OverviewEvents } from 'src/sections/candidate-dashboard/overview/overview-events';
import { OverviewInbox } from 'src/sections/candidate-dashboard/overview/overview-inbox';
import { OverviewTransactions } from 'src/sections/candidate-dashboard/overview/overview-transactions';
import { OverviewPendingIssues } from 'src/sections/candidate-dashboard/overview/overview-pending-issues';
import { OverviewSubscriptionUsage } from 'src/sections/candidate-dashboard/overview/overview-subscription-usage';
import { OverviewHelp } from 'src/sections/candidate-dashboard/overview/overview-help';
