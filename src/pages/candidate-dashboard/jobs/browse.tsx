...
import { CompanyCard } from 'src/sections/candidate-dashboard/jobs/company-card';
import { JobListSearch } from 'src/sections/candidate-dashboard/jobs/job-list-search';
