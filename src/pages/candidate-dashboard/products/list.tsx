...
import { ProductListSearch } from 'src/sections/candidate-dashboard/product/product-list-search';
import { ProductListTable } from 'src/sections/candidate-dashboard/product/product-list-table';
