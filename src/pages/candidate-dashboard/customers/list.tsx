...
import { CustomerListSearch } from 'src/sections/candidate-dashboard/customer/customer-list-search';
import { CustomerListTable } from 'src/sections/candidate-dashboard/customer/customer-list-table';
