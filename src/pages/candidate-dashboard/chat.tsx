...
import { ChatBlank } from 'src/sections/candidate-dashboard/chat/chat-blank';
import { ChatComposer } from 'src/sections/candidate-dashboard/chat/chat-composer';
import { ChatContainer } from 'src/sections/candidate-dashboard/chat/chat-container';
import { ChatSidebar } from 'src/sections/candidate-dashboard/chat/chat-sidebar';
import { ChatThread } from 'src/sections/candidate-dashboard/chat/chat-thread';
