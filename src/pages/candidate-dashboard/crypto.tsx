...
import { CryptoCards } from 'src/sections/candidate-dashboard/crypto/crypto-cards';
import { CryptoOperation } from 'src/sections/candidate-dashboard/crypto/crypto-operation';
import { CryptoWallet } from 'src/sections/candidate-dashboard/crypto/crypto-wallet';
import { CryptoTransactions } from 'src/sections/candidate-dashboard/crypto/crypto-transactions';
import { CryptoUpgrade } from 'src/sections/candidate-dashboard/crypto/crypto-upgrade';
import { CryptoCurrentBalance } from 'src/sections/candidate-dashboard/crypto/crypto-current-balance';
