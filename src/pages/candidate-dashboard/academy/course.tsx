...
import { CourseSummary } from 'src/sections/candidate-dashboard/academy/course-summary';
import { CourseChapter } from 'src/sections/candidate-dashboard/academy/course-chapter';
